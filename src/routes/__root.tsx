    ...
    head: () => ({
      meta: [
        ...
        { title: "Rhoan Barioni — Full Stack Developer" },
        {
          name: "description",
          content:
            "Portfolio of Rhoan Barioni, Full Stack Developer and Computer Science student.",
        },
        { name: "author", content: "Rhoan Barioni" },
        { name: "theme-color", content: "#08080f" },
        { property: "og:site_name", content: "Rhoan Barioni" },
