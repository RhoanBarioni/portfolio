import { a as projects } from "./portfolio-Cjcd-U_u.js";
		...
		children: [
			/* @__PURE__ */ jsxs(Reveal, { children: [
				/* @__PURE__ */ jsxs("div", {
					...
					}), /* @__PURE__ */ jsx(Label, { children: project.year })]
				}),
				/* @__PURE__ */ jsx("h2", {
					id: `${project.id}-title`,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Reveal, {
					...
					children: /* @__PURE__ */ jsx("dl", {
						className: "space-y-7",
						children: CASE_FIELDS.map((field) => /* @__PURE__ */ jsxs("div", {
							className: "border-l border-border pl-6",
							children: [/* @__PURE__ */ jsx("dt", { children: /* @__PURE__ */ jsx(Label, { children: field.label }) }), /* @__PURE__ */ jsx("dd", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(Label, { children: "tech stack" }),
							/* @__PURE__ */ jsx("ul", {
								className: "mt-3 flex flex-wrap gap-1.5",
								children: project.tech.map((tech) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Tag, { children: tech }) }, tech))
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "mt-6 flex flex-wrap gap-2 border-t border-border pt-5",
								children: [project.repo && /* @__PURE__ */ jsxs("a", {
									href: project.repo,
									target: "_blank",
									...
									children: [project.demoLabel, /* @__PURE__ */ jsx(ArrowUpRight, {
										"aria-hidden": true,
...
function Projects() {
	return /* @__PURE__ */ jsxs(PageShell, { children: [/* @__PURE__ */ jsx(PageHeader, {
		...
		className: "mt-16",
		children: projects.map((project, index) => /* @__PURE__ */ jsx(ProjectSection, {
			project,
			index
		}, project.id))
	})] });
