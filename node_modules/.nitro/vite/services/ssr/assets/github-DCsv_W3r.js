import { i as profile } from "./portfolio-Cjcd-U_u.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as githubQuery } from "./github-DIAIuK-o.js";
import { t as Reveal } from "./reveal-DYl8WIbc.js";
import { i as Tag, n as PageHeader, r as PageShell, t as Label } from "./page-DiMtyLZ1.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { useSuspenseQuery } from "@tanstack/react-query";
import { GitBranch, GitCommitHorizontal, Star } from "lucide-react";
//#region src/routes/github.tsx?tsr-split=component
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: repo.name
				}), repo.pinned && /* @__PURE__ */ jsx(Label, { children: "pinned" })]
			}),
			/* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: weeks.map((week) => /* @__PURE__ */ jsx("div", {
				...
				children: week.map((day) => /* @__PURE__ */ jsx("span", {
...
function GithubPage() {
	...
	if (!data.available) return /* @__PURE__ */ jsxs(PageShell, { children: [/* @__PURE__ */ jsx(PageHeader, {
	...
	return /* @__PURE__ */ jsxs(PageShell, { children: [
		...
		/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx("dl", {
			className: "mt-12 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-border bg-border sm:grid-cols-4",
			children: summary.map((item) => /* @__PURE__ */ jsxs("div", {
				className: "bg-background px-5 py-6",
				children: [/* @__PURE__ */ jsx("dt", { children: /* @__PURE__ */ jsx(Label, { children: item.label }) }), /* @__PURE__ */ jsx("dd", {
			...
			children: /* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(ContributionGrid, { days: data.days })
					})
				]
			})
		}),
		data.pinned.length > 0 && /* @__PURE__ */ jsx(Reveal, {
			delay: .05,
			children: /* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					children: data.pinned.map((repo) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(RepoCard, { repo }) }, repo.name))
				})]
			})
		}),
		/* @__PURE__ */ jsx(Reveal, {
			...
			children: /* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					className: "mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3",
					children: data.latest.map((repo) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(RepoCard, { repo }) }, repo.name))
				})]
			})
		}),
		/* @__PURE__ */ jsxs("div", {
			className: "mt-16 grid gap-12 lg:grid-cols-2",
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: data.languages.map((lang, i) => /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: data.languages.map((lang) => /* @__PURE__ */ jsxs("li", {
							className: "flex items-center justify-between py-2.5 text-sm",
							children: [/* @__PURE__ */ jsx("span", { children: lang.name }), /* @__PURE__ */ jsxs("span", {
				...
				children: /* @__PURE__ */ jsxs("section", {
					...
					}), data.commits.length > 0 ? /* @__PURE__ */ jsx("ul", {
						className: "mt-5 divide-y divide-border border-y border-border",
						children: data.commits.map((commit) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", {
							href: commit.url,
							target: "_blank",
							rel: "noreferrer noopener",
		...
		data.activity.length > 0 && /* @__PURE__ */ jsx(Reveal, {
			delay: .05,
			children: /* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					className: "mt-5 divide-y divide-border border-y border-border",
					children: data.activity.map((event) => /* @__PURE__ */ jsxs("li", {
		...
		/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx(Tag, { children: "REST API" }),
				/* @__PURE__ */ jsx(Tag, { children: "no widgets" }),
				/* @__PURE__ */ jsx(Tag, { children: "cached 5 min" })
			]
		}) })
	] });
}
